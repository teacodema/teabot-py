...
async def logVoice(params, guild, member, voice, joining, role_toggle_fct, voice1 = None, voice2 = None):
	...
	if voice.channel and voice_data.__contains__(voice.channel.category_id):
		...
		if joining:
			msg = f'<:userjoin:972798104489304124> {member.mention} joined __**{voice.channel.name}**__'
			...
			msg = f'<:userleft:972798082737655819> {member.mention} left __**{voice.channel.name}**__'
